...
public class Option {
    ...
    public static void executeModifyOption(String option){
        try {
            Connection connn = DriverManager.getConnection("jdbc:mysql://localhost:3306/eBookstore?useSSL=false" , "root" ,"michael11631");
    ...
    public static void executeSearchOption(String option)
    {
        try
        {
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/eBookstore?useSSL=false" , "root" ,"michael11631");
